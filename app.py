...
/* Sidebar collapse/expand toggle — scope tightly to the sidebar-only test IDs.
   Hide descendants so 'keyboard_double_arrow_right' icon-name text can't leak
   through on Streamlit Cloud, then paint our own '»' chevron via ::after.
   Do NOT target button[kind="header"] — that catches the toolbar (Share, Star,
   Edit, GitHub) on the right and clobbers their icons. */
